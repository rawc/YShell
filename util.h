...
class yshell_exn: public runtime_error {
   public:
      ...
      //explicit stops implicit conversions
      //implicit means that wrong data type into method, and 
      //conversion occurs
};
...
bool want_echo();
//controls the output of commands
...
//vector<pair<int,int>> v = new v.....
//if in java would be that^^
...
//##
//creates an operator "<<" which takes in a "stream" and
//"generic" vector
//then loops through entire vector
//and saves into ostream
//##
//
//this takes in a refrence of a vector, and then outputs
//all indexes inside
//needs to be refrence!! if not, will copy all
#endif
